...
(function () {
  ...
  function editController($scope, $routeParams, $http, $location) {
    ...
    $http.get('http://localhost:9000/api/publications/'+noteId).then(function (response) {
    ...
    $scope.updateNote = function() {
        ...
        console.log(data);               
        $http.put('http://localhost:9000/api/publications/'+$scope.publication._id, data).then(function (response) {
